...
- **24 个可在生产环境中使用的技能** - 覆盖架构设计、开发、测试、写作、专利、公文、模板保真填表、文本人化、强力迭代、学术导览
- **14 个中文命令** - 完整中文支持
...
| **shuang-chong (双重)** | 对抗式5角色规划（单模型） | 复杂项目压力测试 |
| **tianbiao (填表)** | 模板保真填表 | 按固定模板填写表格/报表 |
...
| `/公文 <任务>` | 公文撰写 |
| `/人话 <文本>` | AI文本人化处理 |
| `/docx编辑 <文件>` | 无损 DOCX 编辑（改内容保格式） |
| `/docx编辑 unpack <文件>` | 解包 .docx 到目录 |
| `/docx编辑 pack <目录> <输出>` | 从目录重新打包 .docx |
| `/技能` | 列出所有技能 |
| `/学术导览 <领域>` | 学科入门学术导览 |
| `/导览 论文 <领域>` | 仅搜索博士论文 |
| `/导览 站点 <领域>` | 仅整理专业站点 |
